    ...
    <div className="min-h-screen bg-gradient-hero flex items-center justify-center px-6 py-12">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Start your journey with AI-powered travel planning</p>
        </div>
        ...
        <GlassCard className="p-8" hover={false}>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start gap-2">
              <input type="checkbox" className="mt-1 rounded border-glass-border" required />
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-glass-bg/40 text-muted-foreground">Or sign up with</span>
              </div>
            </div>
